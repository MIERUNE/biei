...
use crate::types::{
    GeoJsonOverlay, LngLat, Padding, PathOverlay, PinOverlay, PinSize, StaticOverlay,
};
...
fn pin_image_ids(overlays: &[StaticOverlay]) -> Vec<String> {
    let mut ids = Vec::new();
...
fn pin_image_id(pin: &PinOverlay) -> String {
...
fn pin_icon_offset_y(size: PinSize) -> f32 {
...
fn render_pin_image(pin: &PinOverlay) -> Result<image::DynamicImage, String> {
...
fn label_color_for_pin((r, g, b): (u8, u8, u8)) -> [u8; 3] {
